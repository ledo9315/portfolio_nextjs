    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-color)]">
      <div className="container text-center">
        <div className="max-w-2xl mx-auto">
          <h1 className="font-hanson text-[4rem] sm:text-[6rem] leading-none uppercase text-[var(--accent-color)] mb-6">
            Oops!
          </h1>
          
          <div className="mb-8">
            <h2 className="font-hanson text-[1.5rem] sm:text-[2rem] leading-tight uppercase mb-4 text-[var(--text-color)]">
              Etwas ist schief gelaufen
            </h2>
            <p className="text-[var(--light-grey)] text-lg leading-relaxed mb-6">
